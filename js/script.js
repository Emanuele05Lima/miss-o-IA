        ...
        alternativas: [
            {
                ...
                "A IA analisaa imagem das plantas e roconhece pragas e doenças, auxiliando o pordutor"
            },
            {
                texto:  "Usar a IA para analisar dados da lavoura e indicar quais áreas precisam de maior atenção. ",
                afirmacao: "Porque a IA pode identificar áreas mais afetadas, permitindo um tratamento mais preciso e evitando o uso desnecessário de agrotóxicos. Isso pode diminuir a contaminação e ajudar na preservação da qualidade do solo.", 
                "A IA identifica áreas afetadas, permetindo um tratamento sem agredir o meio ambiente"
            }    
            ...
            alternativas: [
                {
                    ...
                    " A IA visualisa onde estão mais concentadas as pragas, aplicando somente ali o produdo em precisar andar a lavoura inteira"
                },
                {
            ...
            alternativas: [
                {
                    ...
                    "Quando um problema agrícola é tratado com o defensivo errado, as consequências são graves: há um alto prejuízo financeiro com produtos ineficazes e um sério impacto ambiental, causado pela contaminação desnecessária do solo com substâncias tóxicas."
                },
                {
                    ...
                    "Aplicar o defensivo no momento ideal — evitando períodos de chuvas fortes, por exemplo — previne a infiltração incorreta do produto e protege o solo."
                }    
